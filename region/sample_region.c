...
HI_VOID SAMPLE_REGION_MPP_VI_VPSS_VENC_START(HI_VOID)
{
    SAMPLE_REGION_StartVi();
    SAMPLE_REGION_StartVpss();
    SAMPLE_COMM_VI_Bind_VPSS(0, 0, 0);

    SAMPLE_REGION_StartVenc();
...
HI_VOID SAMPLE_REGION_MPP_VI_VPSS_VO_START(HI_VOID)
{
    SAMPLE_REGION_StartVi();
    SAMPLE_REGION_StartVpss();
    SAMPLE_COMM_VI_Bind_VPSS(0, 0, 0);
    SAMPLE_REGION_StartVo();
...
HI_S32 SAMPLE_REGION_VI_VPSS_VO(HI_S32 HandleNum,RGN_TYPE_E  enType,MPP_CHN_S *pstChn)
{
    ...
    SAMPLE_REGION_MPP_VI_VPSS_VO_START();
